...
all_data_class2 = read_seq_new(r'C:\Users\aminu\Documents\COVID-19\CovidVariantsDataset\SARS-CoV-2 (B.1.351)\ncbi_dataset\data\genomic.fna',2)
# all_data_class2 = read_seq_new(r'C:\Users\aminu\Documents\COVID-19\CovidVariantsDataset\SARS-CoV-2 (B.1.617.2)\ncbi_dataset\data\genomic.fna',3)
# all_data_class2 = read_seq_new(r'C:\Users\aminu\Documents\COVID-19\CovidVariantsDataset\SARS-CoV-2 (C.37)\ncbi_dataset\data\genomic.fna',4)
# all_data_class2 = read_seq_new(r'C:\Users\aminu\Documents\COVID-19\CovidVariantsDataset\SARS-CoV-2 (P.1)\ncbi_dataset\data\genomic.fna',5)
...
f y_train.shape[0] > x_train.shape[0]:
...
class VAE(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        return {
            ...
            "construction_loss": self.reconstruction_loss_tracker.result(),
...
plot_Gen_Loss(history,'Generator_nuc')
...
fileName = 'VAEseqGen_Nucleotides_Model'
vae.save(fileName)
